...
@WebServlet("/addaboutadmin")
@MultipartConfig
public class AddAboutDBServlet extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if (hs == null) {
			...
			int k = new AddAboutDAO().addAbout(ab);
			if (k > 0) {
				req.setAttribute("msg", "About Data Added Successfully!!!");
